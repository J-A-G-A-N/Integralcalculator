...
class Frame3(ctk.CTkFrame):
     def __init__(self, master, **kwargs):
        ...
        def clear(
             enc_function,
                enc_inner_Variable,
                enc_outer_Variable_1,
                enc_outer_Variable_2,
                enc_inner_ll,
                enc_inner_ul,
                enc_outer_ll_1,
                enc_outer_ul_1,
            ...
            enc_outer_Variable_1.delete(0, END)
            enc_outer_Variable_2.delete(0, END)
            enc_inner_ll.delete(0, END)
            enc_inner_ul.delete(0, END)
            enc_outer_ll_1.delete(0, END)
            enc_outer_ul_1.delete(0, END)
            enc_outer_ll_2.delete(0, END)
            enc_outer_ul_2.delete(0, END)
        ...
        def Output(func,var_1,var_2,inner_ll, inner_ul, outer_ll, outer_ul, result):
            ...
            outer_variable_1.configure(text=var_2)
            outer_variable_2.configure(text=var_2)
            ...
            out_outer_variable_1_txt.configure(text="Outer Variable :")
            out_outer_variable_2_txt.configure(text="Outer Variable :")
            out_inner_ll_txt.configure(text="Inner Lower Limit :")
            out_inner_ul_txt.configure(text="Inner Upper Limit :")
            out_outer_ll_1_txt.configure(text="Outer Lower Limit :")
            out_outer_ul_1_txt.configure(text="Outer Upper Limit :")
            out_outer_ll_2_txt.configure(text="Outer Lower Limit :")
            out_outer_ul_2_txt.configure(text="Outer Upper Limit :")
        ...
        def work():
            ...
            var_2 = enc_outer_Variable_1.get()
            inner_ll = enc_inner_ll.get()
            inner_ul = enc_inner_ul.get()
            outer_ll = enc_outer_ll_1.get()
            outer_ul = enc_outer_ul_1.get()
            uter_ll = enc_outer_ll_2.get()
            outer_ul = enc_outer_ul_2.get()
            result = Integrand(
        ...
        enc_outer_Variable_1 = ctk.CTkEntry(
            self,
            fg_color="white",
            bg_color="#1F1E1E",
            width=170,
        ...
        enc_outer_Variable_1.place(x=15, y=170)

        enc_outer_Variable_2 = ctk.CTkEntry(
            self,
            fg_color="white",
            bg_color="#1F1E1E",
            width=170,
        ...
        enc_outer_Variable_2.place(x=15, y=170)
        ...
        enc_outer_ll_1.place(x=15, y=275)

        # Enter outer Upper Limit
        enc_outer_ul_1 = ctk.CTkEntry(
            self,
            fg_color="white",
            bg_color="#1F1E1E",
            width=170,
        ...
        enc_outer_ul_1.place(x=15, y=310)


         # Enter  outer Lower Limit
        enc_outer_ll_2 = ctk.CTkEntry(
            self,
            fg_color="white",
            bg_color="#1F1E1E",
            width=170,
        ...
        enc_outer_ll_2.place(x=15, y=275)

        # Enter outer Upper Limit
        enc_outer_ul_2 = ctk.CTkEntry(
            self,
            fg_color="white",
            bg_color="#1F1E1E",
            width=170,
        ...
        enc_outer_ul_2.place(x=15, y=310)
        ...
        outer_variable_1.place(x=470, y=150)

        outer_variable_2 = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        outer_variable_2.place(x=470, y=150)
        ...
        out_outer_variable_1_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_variable_1_txt.place(x=300, y=150)


        out_outer_variable_2_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_variable_2_txt.place(x=300, y=150)
        ...
        out_outer_ll_1_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_ll_1_txt.place(x=300, y=225)

        out_outer_ul_1_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_ul_1_txt.place(x=300, y=250)

        out_outer_ll_2_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_ll_2_txt.place(x=300, y=225)

        out_outer_ul_2_txt = ctk.CTkLabel(
            self,
            text="",
            bg_color="#1F1E1E",
            text_color="#FFFFFF",
        ...
        out_outer_ul_2_txt.place(x=300, y=250)
